                        ...
                        <div class="row align-items-end gx-3 gy-2">
                            ...
                            <?php if ($isEdit): ?>
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" value="<?= htmlspecialchars($edit['email'] ?? 'N/A') ?>" readonly />
                                </div>
                            <?php endif; ?>
            ...
            <?php $i = 0; foreach ($data["productList"] as $k => $v): $i++; ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?= $baseUrl ?>/deleteProductType/<?= urlencode($v["maLoaiSP"]) ?>" class="btn btn-danger btn-sm"
                            onclick="return confirm('Bạn có chắc muốn xoá loại sản phẩm này?');">🗑️ Xoá</a>
                    </td>
                </tr>
            <?php endforeach; else: ?>
            <tr>
                <td colspan="6" class="text-center text-muted">Chưa có danh mục loại sản phẩm nào. Hãy thêm mới ở form phía trên.</td>
            </tr>
            <?php endif; ?>
        </table>
</div>
